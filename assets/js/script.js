...
lightToDarkButton?.addEventListener("click", function () {
  if (localStorage.getItem("scheme") === "light") {
    ...
    this?.classList.add("dark--version");
    this?.classList.remove("light--version");
    return;
  } else {
    document.documentElement.classList.remove("dark");
    localStorage.setItem("scheme", "light");
    this?.classList?.remove("dark--version");
    this?.classList?.add("light--version");
  }
});
...
if (localStorage.getItem("scheme") === "dark") {
  ...
  lightToDarkButton?.classList?.remove("light--version");
}
if (localStorage.getItem("scheme") === "light") {
  document.documentElement.classList.add("light");
  lightToDarkButton?.classList?.remove("dark--version");
  lightToDarkButton?.classList?.add("light--version");
}
// Toggle navigation
...
setTimeout(() => {
  document
    .querySelector(".preloader-dot-loading")
    .setAttribute("style", "opacity:0;transition:0.5s ease-out");
  document
    .querySelector("main.main__content_wrapper")
    .setAttribute("style", "display:block");
  document.querySelector("header").setAttribute("style", "display:block");
  document
    .querySelector(
      ".button-group.filters-button-group.mb-50 button:first-child",
    )
    .click();
}, 500);
setTimeout(() => {
  document
    .querySelector(".preloader-dot-loading")
    .setAttribute("style", "display:none;opacity:0;transition:0.5s ease-out");
}, 1000);
